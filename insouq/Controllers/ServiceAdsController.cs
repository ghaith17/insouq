...
namespace insouq.Controllers
{
    ...
    public class ServiceAdsController : ControllerBase
    {
        ...
        public async Task<IActionResult> Add([FromForm] ServiceAdDTO dataModel)
        {
            ...
            var response = await _serviceAdsService.AddServiceAd((int)userId, dataModel,hostName);
        ...
        public async Task<IActionResult> FilterServices([FromForm] ServiceFilters dataModel)
        {
        ...
        public async Task<IActionResult> Update([FromForm] ServiceAdDTO dataModel)
        {
            ...
            var hostName = $"https://{this.Request.Host}";
            var response = await _serviceAdsService.UpdateServiceAd((int)userId, dataModel,hostName);
