...
namespace insouq.EntityFramework.Migrations
{
    ...
    [Migration("20210823084908_removeMakerFromDLEngineSize")]
    partial class removeMakerFromDLEngineSize
    {
            ...
            modelBuilder.Entity("insouq.Models.NumberAd", b =>
                {
                    ...
                    b.Property<string>("CurrentNetwork")
                        .HasMaxLength(256)
                        .HasColumnType("nvarchar(256)");
