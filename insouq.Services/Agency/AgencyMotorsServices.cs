...
{
    public class AgencyMotorsServices : IAgencyMotorsServices
    {
        ...
        public AgencyMotorsServices(ApplicationDbContext db, IMapper mapper, IWebHostEnvironment hostEnvironment, IDropDownService dropDownService)
        {
            _db = db;
            _mapper = mapper;
        ...
        public async Task<BaseResponse> Add(int userId, Shared.DTOS.AgencyDTOS.MotorsAdDTO model, string host)
        {
